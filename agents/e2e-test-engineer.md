...
Validar flujos completos mediante pruebas e2e o ejecucion manual reproducible.
...
- e2e, regresion, navegacion, escenarios criticos.
...
- Contexto maximo esperado: `160k` tokens.
- Tiempo maximo recomendado: `30m`.
- Coste esperado: `medium`.
- Usar un modelo diferente cuando: Cambiar a mayor contexto si el flujo cruza muchos servicios.
