...
Consolidar cambios, validaciones, riesgos, pendientes y decision final.
...
- resumen tecnico, handoff, riesgos, decision final.
...
- Modelos alternativos: `gpt-5`.
- Nivel de razonamiento requerido: `low-medium`.
- Nivel de creatividad: `low`.
- Contexto maximo esperado: `80k` tokens.
- Tiempo maximo recomendado: `8m`.
- Coste esperado: `low`.
- Usar un modelo diferente cuando: Cambiar a modelo mayor si debe reconciliar reportes contradictorios.
