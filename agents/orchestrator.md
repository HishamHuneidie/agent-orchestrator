...
Coordinar el ciclo completo de una feature, gobernar fases, permisos, estado, coste, riesgo y calidad.
...
- orquestacion, routing, politica, estado, quality gates.
...
- Usar un modelo diferente cuando: Cambiar a modelo de mayor razonamiento si hay dependencias complejas o riesgo alto.
