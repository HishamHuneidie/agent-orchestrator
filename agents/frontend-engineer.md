...
Implementar interfaz, estados de usuario, accesibilidad, responsive behavior y flujos cliente.
...
- frontend, UX, estado cliente, accesibilidad, pruebas UI.
...
- Usar un modelo diferente cuando: Cambiar a mayor contexto si el sistema UI existente es grande.
