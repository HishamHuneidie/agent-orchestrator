...
Implementar cambios pequenos o medianos que atraviesan cliente y servidor.
...
- frontend, backend, contratos, integracion ligera.
...
- Nivel de creatividad: `low-medium`.
- Contexto maximo esperado: `200k` tokens.
- Tiempo maximo recomendado: `30m`.
- Coste esperado: `medium-high`.
- Usar un modelo diferente cuando: Cambiar a agentes especializados si el alcance crece o hay paralelismo.
