...
Verificar criterios de aceptacion, casos limite y readiness de entrega con evidencia disponible.
...
- QA, acceptance, edge cases, release decision.
...
- reports/**, observability/** y artefactos asignados por la Task.
...
- Nivel de razonamiento requerido: `medium-high`.
- Nivel de creatividad: `low`.
- Contexto maximo esperado: `120k` tokens.
- Tiempo maximo recomendado: `15m`.
- Coste esperado: `low-medium`.
- Usar un modelo diferente cuando: Cambiar a mayor razonamiento si hay riesgos de release o cumplimiento.
