...
Crear y ejecutar pruebas unitarias focalizadas sobre logica modificada.
...
- unit tests, fixtures, mocks, cobertura focalizada.
...
- Modelos alternativos: `gpt-5, gpt-5-thinking`.
- Nivel de razonamiento requerido: `medium`.
- Nivel de creatividad: `low`.
- Contexto maximo esperado: `120k` tokens.
- Tiempo maximo recomendado: `20m`.
- Coste esperado: `low-medium`.
- Usar un modelo diferente cuando: Cambiar a mayor razonamiento si las pruebas requieren diseno complejo.
