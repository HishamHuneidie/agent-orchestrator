...
Revisar diffs para detectar bugs, regresiones, riesgos, seguridad, arquitectura y pruebas faltantes.
...
- review, analisis de diffs, seguridad, mantenibilidad.
...
- Modelo recomendado: `gpt-5-thinking`.
- Modelos alternativos: `gpt-5, gpt-5-mini`.
...
- Usar un modelo diferente cuando: Cambiar a modelo mas barato para cambios triviales y bien testeados.
