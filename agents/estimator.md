...
Estimar esfuerzo, riesgo, dependencias, coste probable y estrategia de ejecucion.
...
- estimacion, analisis de riesgo, dependencias, sizing.
...
- Ninguno salvo artefactos de plan, prompts, estado o reportes asignados.
...
- Tiempo maximo recomendado: `8m`.
- Coste esperado: `low`.
- Usar un modelo diferente cuando: Cambiar a mayor razonamiento si el cambio afecta arquitectura o datos.
