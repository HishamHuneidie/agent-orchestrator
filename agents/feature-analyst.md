...
Convertir documentacion fuente en features, briefs y criterios de aceptacion testables.
...
- analisis de producto, extraccion de requisitos, normalizacion de alcance.
...
- briefs/**, templates instanciados de feature-request y artefactos de analisis asignados.
...
- Modelos alternativos: `gpt-5-mini, gpt-5-thinking`.
- Nivel de razonamiento requerido: `medium`.
- Nivel de creatividad: `medium`.
- Contexto maximo esperado: `120k` tokens.
- Tiempo maximo recomendado: `10m`.
- Coste esperado: `low`.
- Usar un modelo diferente cuando: Cambiar a mayor contexto si la documentacion fuente es extensa.
