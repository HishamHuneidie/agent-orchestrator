...
Transformar features estimadas en tareas ejecutables con dependencias, artefactos y validaciones.
...
- planificacion, desglose tecnico, definicion de tareas.
...
- execution-plan.yaml, tasks/**, runtime/state/** y artefactos de plan asignados.
...
- Tiempo maximo recomendado: `12m`.
- Coste esperado: `medium`.
- Usar un modelo diferente cuando: Cambiar a modelo de mayor contexto si hay multiples subsistemas.
